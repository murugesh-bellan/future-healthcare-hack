...
import * as module_2 from "../../agent/tools/confirm-consent.ts";
import * as module_3 from "../../agent/tools/save-check-in.ts";
  ...
  "nodes": Object.freeze({
      "__root__": Object.freeze({
              "modules": Object.freeze({
                  ...
                  "tools/confirm-consent.ts": module_2,
                  "tools/save-check-in.ts": module_3
                })
            })
    })
});
